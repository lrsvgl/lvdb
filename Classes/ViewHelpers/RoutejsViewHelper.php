...
class RoutejsViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractTagBasedViewHelper {
	 ...
	 * @return string
	 */
	 public function render($startingPoint, $destination) {
	
		$out = $this->getMapJavascript($startingPoint, $destination);
		...
		for ($i = 0; $i < count($locations); $i++) {
			...
			$out .= 'var shadow = new google.maps.MarkerImage("typo3conf/ext/stores/Resources/Public/Icons/shadow.png",
			...
			if ($locations[$i]['icon']) {
 			$out .= 'marker[' . $i . '] = new google.maps.Marker({
					                ...
					                icon: "uploads/tx_stores/icons/' . $locations[$i]['icon'] .'",
					                shadow: shadow
					                });
 			...
 			$out .= 'marker[' . $i . '] = new google.maps.Marker({
					                ...
					                map: map,
					                title: "' . $locations[$i]['name'] .'",
					                icon: "typo3conf/ext/stores/Resources/Public/Icons/pointerBrown.png",
					                shadow: shadow
					                });
									mapBounds.extend(myLatLng);
